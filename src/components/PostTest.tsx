...
import { postTestQuestions } from '../data/testQuestions';
...
const PostTest: React.FC<PostTestProps> = ({ onTestComplete }) => {
  ...
  const currentQuestion = postTestQuestions[currentQuestionIndex];
          ...
          <div className="mb-6">
            ...
            {score >= 16 && (
              <div className="bg-green-100 p-4 rounded-lg mb-6">
                <h3 className="font-semibold text-green-800">🎉 Outstanding Achievement!</h3>
                <p className="text-green-600">You've mastered fraction operations!</p>
              </div>
            )}
            
            {score >= 12 && score < 16 && (
              <div className="bg-blue-100 p-4 rounded-lg mb-6">
                <h3 className="font-semibold text-blue-800">📈 Great Progress!</h3>
                <p className="text-blue-600">You've shown significant improvement in fractions!</p>
              </div>
            )}
            
            {score < 12 && (
              <div className="bg-yellow-100 p-4 rounded-lg mb-6">
                <h3 className="font-semibold text-yellow-800">📚 Keep Learning!</h3>
                <p className="text-yellow-600">Consider reviewing the game levels for additional practice.</p>
              </div>
            )}
          </div>
